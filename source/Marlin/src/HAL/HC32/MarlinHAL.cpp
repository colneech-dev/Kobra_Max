...
void MarlinHAL::init() {
  ...
  // Release JTAG/SWD pins so PA13/PA14/PA15/PB3/PB4 are available as GPIO.
  // PA15 = TMC2209 UART RX; PA14 = CONTROLLER_FAN_PIN; PA13 = FAN1_PIN.
  // Without this they remain in debug-port function after reset.
  JTAGSWD_DISABLE();
  ...
  if (freeMemory() < 1024) {
    SERIAL_ERROR_MSG("HAL: low memory after init!\n");
  }
}

void MarlinHAL::init_board() {
  // Initialize Anycubic strain-gauge auto-level probe TX line
